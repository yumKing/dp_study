...
import elastic.test.client.bytesAdapter.WritableUtils;
...
public class Text  {
   ...
   * @see Writable#toBytes(java.io.DataOutput)
   */
   ...
   * @throws java.nio.charset.MalformedInputException if the byte array contains invalid utf-8
   */
